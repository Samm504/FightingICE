...
public class GameSetting {
    ...
    /**
     * FPS (Frames Per Second) setting for the game.
     */
    public static final int FPS = 60;

    /**
     * Array that stores the characters that can be used in the game.
     */
    public static final String[] CHARACTERS = {"ZEN", "GARNET", "LUD"};

    /**
     * Array that stores the default repetition numbers for the game.
     */
